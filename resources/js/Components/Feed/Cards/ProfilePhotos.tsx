...
export default function ProfilePhotos({ id, user, description, updated_at }: Props) {
    ...
    return (
        <FeedCard>
            ...
            <div className="w-full aspect-[42/9] rounded-md overflow-hidden bg-center bg-cover relative shadow-md"
                style={{
