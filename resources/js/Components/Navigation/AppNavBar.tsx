        ...
        <nav className="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <div className="hidden sm:flex sm:items-center sm:ml-6">
                        <div className="ml-3 flex items-center gap-x-3 relative">
                            ...
                            >
                                ...
                                <DropdownLink as="a" href="https://kartsocial.canny.io/report-issues">
                                    Report Issues
                                </DropdownLink>
                                <DropdownLink as="a" href="https://kartsocial.canny.io/feature-requests">
                                    Feature Requests
                                </DropdownLink>
                                <DropdownLink as="a" href="https://kartsocial.canny.io/changelog">
                                    Changelog
                                </DropdownLink>
                            </Dropdown>
                            ...
                            {/* <!-- Account Dropdown --> */}
                            {
                                page.props.auth.user && (
                                    ...
                                    >
                                        ...
                                        <DropdownLink href={route('profile.show', { alias: page.props.auth.user?.alias })}>
                                            View My Profile
                                        </DropdownLink>
                                        ...
                                        <DropdownLink href={route('user-invitations.show')}>
                                            <div className="text-center -mb-0.5">
                                                <div className="bg-gray-200 text-gray-900 w-full rounded-full text-xs py-0 leading-none text-center relative h-[12px] mb-0.5">
                                                    <div className="absolute z-20 w-full">{page.props.auth.user.invited_count}/{page.props.max_invites}</div>
                                                    <div
            ...
            >
                <div className="pt-2 pb-3 space-y-1">
                    <ResponsiveNavLink as="a" href="https://kartsocial.canny.io/report-issues">
                        Report Issues
                    </ResponsiveNavLink>
                    <ResponsiveNavLink as="a" href="https://kartsocial.canny.io/feature-requests">
                        Feature Requests
                    </ResponsiveNavLink>
                    <ResponsiveNavLink as="a" href="https://kartsocial.canny.io/changelog">
                        Changelog
                    </ResponsiveNavLink>
                </div>
            </div>
                    ...
                    page.props.auth.user && (
                        <div className="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                            ...
                            <div className="mt-3 space-y-1">
                                <ResponsiveNavLink
                                    href={route('profile.show', { alias: page.props.auth.user.alias })}
