    ...
    <Select
      ...
      classNames={{
        menuButton: ({ isDisabled }) =>
          `flex border border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-md transition-all duration-300 focus:outline-none ${
            isDisabled
        ...
        searchBox:
          'w-full pl-8 text-sm border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 rounded-md',
      }}
      {...props}
    />
  );
