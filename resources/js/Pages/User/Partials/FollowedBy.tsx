...
export default function FollowedBy({ user }: any) {
  ...
  return (
    <div className="hidden md:flex flex-col items-center gap-2 py-3 px-4 bg-white border -mt-px rounded-lg dark:text-white dark:bg-gray-800 dark:border-gray-700">
