...
export function Marker(props: MarkerProps): JSX.Element {
    ...
    return (
        <div
            ...
            className={props.className ? `${props.className} pigeon-click-block` : `pigeon-click-block ${hover ? 'z-50' : ''}`}
        ...
        >
            {props.children || (
                <div className={`flex flex-row items-center `}>
                    ...
                    {
                        hover ?
                            <div className="bg-black/70 text-white rounded-lg p-1">{props.text}</div>
                            : null
                    }
                </div>
            )}
