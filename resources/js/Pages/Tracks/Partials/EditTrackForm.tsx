...
export default function EditTrackForm({ track }: any) {
  ...
  const form = useForm({
    _method: 'PUT',
    name: track.name,
    address_1: track.address_1,
    address_2: track.address_2,
    address_3: track.address_3,
    town: track.town,
    county: track.county,
  ...
  function updateTrack() {
    form.put(route('tracks.update', { track: track.id }), {
      errorBag: 'trackUpdate',
    });
  }
