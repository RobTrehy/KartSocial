...
export default function DeleteSessionForm({ event, session }: Props) {
  ...
  function deleteSession() {
    form.delete(
      route('events.sessions.destroy', { event: event, session: session }),
      {
        preserveScroll: true,
  ...
  return (
    ...
    >
      <div className="max-w-xl text-sm text-gray-600 dark:text-gray-400">
        Selecting to delete this session, will permenantly remove all drivers laps also
