            ...
            renderHeader={() => (
                <div className="flex flex-row items-center">
                    ...
                    <div className="ml-auto flex gap-x-2">
                        ...
                        <SecondaryButton onClick={() => router.visit(route('admin:users.activity', { user: user.id }))}>
                            User Activity
                        </SecondaryButton>
        ...
        >
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 flex flex-col gap-y-2">
                    <p>The account was restricted by {user.ban.banner.alias} on {moment(user.ban.created_at).format('Do MMMM YYYY [at] HH:mm')}</p>
                    {
                        user.ban.expires_at
                            ? <p>The restriction expires on: {moment(user.ban.expires_at).format('Do MMMM YYYY')}</p>
