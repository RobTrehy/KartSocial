      ...
      {props.laps?.map((lap: any, i: number) => {
        return (
          <div className="flex mb-1.5 items-center" key={i}>
            ...
            {lap.lap_number != 1 ? (
              <div
                className={`border border-gray-300 dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 shadow-sm py-2 px-3 w-32 ${
                  lap.lap_diff < 0
              ...
              <div className="border border-gray-300 dark:border-gray-800 shadow-sm py-2 px-3 w-32 bg-gray-100 dark:bg-gray-600">
                &nbsp;
              </div>
            )}
